...
func templatesSearcherTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/searcher.tmpl", size: 2072, mode: os.FileMode(420), modTime: time.Unix(1461959719, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
